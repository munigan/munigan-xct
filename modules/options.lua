...
\/>  </ \ \ \L\ \ \ \ \/__/\_\_/
 ...
 addon.options = {
  ...
  name = "                                                      " .. "Version: "..(GetAddOnMetadata(ADDON_NAME, "Version") or "Unknown") .. "                                                      ",
   handler = x,
   type = 'group',
   args = {
    muniganTitle = {
       ...
       type = 'description',
       fontSize = 'large',
      name = "|cffFF8000Munigan|r |cff798BDDConfiguration Tool|r\n",
       width = 'double',
     },
     ...
     hideConfig = {
      ...
      set = function(info, value) x.db.profile.hideConfig = value; if not value then StaticPopup_Show("MUNIGAN_XCT_HIDE_IN_COMBAT") end end,
     },
     --[==[RestoreDefaults = {
       order = 3,
       type = 'execute',
 ...
 addon.options.args["Credits"] = {
   ...
   args = {
     ...
     userName1 = {
       ...
       order = 5,
       fontSize = "medium",
      name = "This build is customized as |cff22FF80MuniganXCT|r for the Munigan UI.",
     },
     testerTitleSpace2 = {
       type = 'description',
       order = 6,
     ...
     contactStep1 = {
       type = 'description',
       order = 8,
      name = "1. GitHub: |cff22FF80https://github.com/munigan/munigan-xct|r",
     },
   },
 }
